...
import { GridEventNoobProHacker, GuessTime, MatchYourTier, PlacementTest } from '@/types/content'

type Props = PlacementTestProps | MatchYourTierProps | GuessTimeProps | GridEventNoobProHackerProps
